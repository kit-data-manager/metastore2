...
Obtaining all accessible datacite records of schema documents. 
...
----
At least the following elements has to be provided by the user: 
...
[NOTE]
If linked schema is identified by its schemaId the INTERNAL type has to be used. It's than
