    ...
    try {
      switch (version) {
        ...
        case V201909:
          ...
          break;
        default:
          String message = String.format("Error: Unknown json schema version: '%s'", version);
          LOG.error(message);
      ...
      throw new JsonValidationException("Error downloading resource from '" + resourceUrl.toString() + "'!", tw);
    }
